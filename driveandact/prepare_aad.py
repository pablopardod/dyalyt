...
def processData():
    ...
    #Added all YES in the above list
    #columns_upper_body = [2, 3, 4, 6, 7, 8, 10, 11, 12, 18, 19, 20, 26, 27, 28, 34, 35, 36, 42, 43, 44,50,51,52, 54, 55, 56, 58, 59, 60,66,67,68, 70, 71, 72, 74, 75, 76,78,79,80, 82, 83, 84, 90, 91, 92,94,95,96]
...
if __name__ == '__main__':
    ...
    if opt.coarse_label:
        print('Processing coarse labels...')
        root_dir = './activities_3s/a_column_driver'
